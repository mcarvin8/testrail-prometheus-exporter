...
test_run_passed_count = Gauge(
    "test_run_passed_count", "Number of passed tests", ["run_id", "created_date"]
)
test_run_failed_count = Gauge(
    "test_run_failed_count", "Number of failed tests", ["run_id", "created_date"]
)
test_run_retest_count = Gauge(
    "test_run_retest_count", "Number of tests to retest", ["run_id", "created_date"]
)
test_run_untested_count = Gauge(
    "test_run_untested_count", "Number of untested tests", ["run_id", "created_date"]
)
test_run_blocked_count = Gauge(
    "test_run_blocked_count", "Number of blocked tests", ["run_id", "created_date"]
)

test_result_info = Gauge(
    "testrail_test_result",
    "Information about individual test results",
