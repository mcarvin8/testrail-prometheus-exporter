...
if __name__ == "__main__":
    ...
    CUSTOM_STATUS_CONFIG_PATH = os.getenv(
        "CUSTOM_STATUS_CONFIG", "custom_statuses.json"
    )
    ...
    custom_status_gauges = (
        create_custom_status_gauges(custom_status_config)
        if custom_status_config
        else None
    )
    ...
    scheduler.add_job(
        func=lambda: expose_test_reports(
            authentication, PROJECT_ID, LOOKBACK_DAYS, custom_status_gauges
        ),
