...
The TestRail Prometheus Exporter is a long-running service that polls the TestRail API on a configurable interval for completed test runs and exposes detailed test metrics as Prometheus metrics.
